...
* [Web Browser](#build-your-own-web-browser)* [DNS](#build-your-own-dns)
...
* [**JavaScript**: _Build Your First Blockchain App Using Ethereum Smart Contracts and Solidity_](https://www.youtube.com/watch?v=coQ5dg8wM2o&t=3244s)
...
* [**Go**: _How to make a responsive telegram bot_ ](https://www.sohamkamani.com/golang/telegram-bot/)
...
* [**Node.js**: _Build a hashtag tweet viewing tool with Node.js & the Twitter API ](https://www.codewall.co.uk/how-to-build-a-twitter-hashtag-viewing-tool-tutorial/)
...
* [**Node.js**: _How to build a Slack Bot with Node.js and SlackBots.js_](https://www.freecodecamp.org/news/building-a-slackbot-with-node-js-and-slackbots-js/)
...
* [**C**: _Othello Game in C_](https://www.hanshq.net/othello.html#win)
...
* [**JavaScript**: _Make JavaScript Games (with Kaboom.js)_](https://makejsgames.com)
...
* [**Java**: _Your Own Proxy Server_](https://people.apache.org/~jim/NewArchitect/webtech/2001/04/java/index.html)
* [**PuTTY**: _Your Own PuTTY proxy server_](https://dzone.com/articles/guide-to-make-your-own-proxy-for-more-ips)
* [**Proxy server**: _Building your own proxy server_](https://networkjutsu.com/building-your-own-proxy-server/)
* [**Proxy server**: _Guide to Make Your Own Proxy for More IPs_](https://dzone.com/articles/guide-to-make-your-own-proxy-for-more-ips)
...
* [**Python**: _An Introduction to RLU in Artificial Neural Networks_](https://www.nbshare.io/notebook/584445049/Rectified-Linear-Unit-For-Artificial-Neural-Networks-Part-1-Regression/)
...
* [**C**: _OS Development using the Linux Kernel_](https://www.youtube.com/watch?v=7yE_WafMOVI&list=PLVxiWMqQvhg8ZisiOBLAVkhLOYCkzTst0)
...
* [**C#**: _Monaidc parser combinators_](https://tyrrrz.me/blog/monadic-parser-combinators)
...
* [**Java**: _Build a Tiny Compiler in Java_](https://medium.com/javarevisited/build-a-tiny-compiler-in-java-662f67a1ce85)
...
* [**C**: _A list of tutorials that explain how to create small and medium projects with C_](https://github.com/rby90/project-based-tutorials-in-c)
...
* [**JavaScript**: _How to Make an Evolutionary Tetris AI (Original Author)_](https://idreesinc.com/about-tetnet.html)
...
* [**Rust**: _Writing an API with Rust to parse and extract info from Apk_ ](https://benyaamin.com/post/writing-an-api-with-rust-to-parse-and-extract-info-from-apk)
* [**Rust**: _Implementing trivial file transfer protocol_](https://nurmohammed840.github.io/tftp.rs/)
* [**TypeScript**: _Tiny Package Manager: Learns how npm or Yarn works_](https://github.com/g-plane/tiny-package-manager)
* [**Python**: DIY Async Web Framework](https://github.com/hzlmn/diy-async-web-framework)
